...
for fasta_name in fasta_list:
    ...
    os.system("python blockParse.py -f {}.fa -l 40 -L 40 -F 60 -s 330 -S 20".format(fasta_handle))
    os.system("bowtie2 -x /mnt/gpfs/Database/ref/hg38/hg38 -U {}.fastq --no-hd -t -k 100 --very-sensitive-local -S {}.sam".format(fasta_handle,fasta_handle))
